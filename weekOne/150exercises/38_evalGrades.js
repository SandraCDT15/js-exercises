...
const excelentGrade = (totMarks, isExam = false) => isExam ? totMarks >= 90 : totMarks >= 89 && totMarks <= 100;

console.log(excelentGrade(78));
console.log(excelentGrade(89, true));
console.log(excelentGrade(99, true));